...
@Component({
  selector: 'app-list-cve',
  templateUrl: './list-cve.component.html',
  styleUrls: ['./list-cve.component.css']
})
export class ListCveComponent implements OnInit {
...
// il faut implementer cette fonction
  AfficherLesCves(id : number){
